    ...
    <div class="flex flex-col text-[#331B3B]">
      ...
      <div class="basis-3/4 mt-14 max-lg:mx-[50px] ">
        <div class="flex flex-row justify-center space-x-16 max-lg:flex-col max-lg:space-y-16 max-lg:grid max-lg:justify-items-center max-lg:space-x-0">
          ...
          <div class="flex w-[448px] h-[310px] shadow-[0px_0px_7px_1px_rgba(0,0,0,0.08)] max-md:w-[70%] max-sm:w-[65%]">

            <div class="flex flex-col p-10 self-center">

              <div class="basis-2/6">
                <img class="max-sm:w-[30px]" src="../../assets/testimonia.png" alt="">
              </div>

              <div class="basis-3/6 mt-[18px] mb-1">
                <p class="font-normal text-lg max-xl:text-base max-sm:text-sm">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
              </div>
