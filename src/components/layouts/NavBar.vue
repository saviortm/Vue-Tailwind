<template>
    <div>
        <transition name="fade">
            <!-- Main modal -->
            <div v-if="modal" id="authentication-modal" tabindex="-1" aria-hidden="true"
                 class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full flex backdrop-blur-sm">
                <div class="relative w-full h-full md:h-auto flex justify-center self-center">
                    ...
                    <div v-if="isModalVisible" class="relative bg-white rounded-lg shadow w-2/5">
                        <button @click="showModalClose" type="button"
                                    ...
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input id="remember" type="checkbox" value=""
                                                   class="modal__checkbox w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#5f1e75]">
                                        </div>
                                        <label for="remember" class="ml-2 text-sm font-medium text-gray-900">Remember
                                            me</label>
                                    </div>
                                    <a href="#" class="text-sm text-[#331B3B] hover:underline dark:text-blue-500">Lost
                                        Password?</a>
                                </div>
                                <button @click="submitForm" type="submit"
                                        class="w-full text-white bg-[#331B3B] hover:bg-[#240230] focus:ring-4 focus:outline-none focus:ring-[#5f1e75] font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                    Login to your account
                                </button>
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                    Not registered?
                                    <router-link to="/signup" class="text-[#331B3B] hover:underline">Create account
                                    </router-link>
                                </div>
                            </form>
                        </div>
        ...
        <Transition name="slide-fade-success">
            <div v-if="alertSuccess"
                 class="fixed top-0 right-0 z-50 px-8 py-6 bg-green-400 text-white flex justify-between rounded">
        ...
        <Transition name="slide-fade-danger">
            <div v-if="alertDanger"
                 class="fixed top-0 right-0 z-50  px-8 py-6 bg-red-400 text-white flex justify-between rounded">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mr-6" viewBox="0 0 20 20"
                         fill="currentColor">
                        <path fill-rule="evenodd"
            ...
            <div class="flex justify-between h-[100px] mx-[50px] max-sm:mx-2">
                ...
                <div
                    ...
                    <ul class="flex space-x-8 font-normal text-base text-[#331B3B] max-lg:flex-col max-lg:space-y-4 max-lg:p-20">
                        ...
                        <div
                            class="hidden peer-hover:flex hover:flex absolute w-[400px] h-32 flex-row drop-shadow-lg max-md:w-[300px] max-sm:w-[200px]">
                            ...
                            <div class="flex basis-2/3 flex-col max-sm:basis-1/2">
                                ...
                                <a class="bg-[#331B3B] text-white px-5 py-3 hover:bg-[#240230] rounded-b-lg" href="#">Privacy
                                    Policy</a></div>
                        </div>
                        <li class="z-10">
                            <a class="max-lg:p-1" href="">
                ...
                <div
                    ...
                    <ul class="flex space-x-8 font-normal text-base text-[#331B3B] max-lg:flex-col max-lg:space-y-4 max-lg:p-20">
                        ...
                        <div class="hidden peer-hover:flex hover:flex absolute w-[200px] flex-col drop-shadow-lg">
                            <a class="px-5 py-3 bg-transparent" href="#"></a>
                            <a class="px-5 py-3 bg-transparent" href="#"></a>
                            <a class="bg-[#331B3B] text-white px-5 py-3 hover:bg-[#240230] rounded-t-lg"
                               href="#">Career</a>
                            <a class="bg-[#331B3B] text-white px-5 py-3 hover:bg-[#240230]" href="#">Company</a>
                            <a class="bg-[#331B3B] text-white px-5 py-3 hover:bg-[#240230] rounded-b-lg" href="#">Privacy
                                Policy</a>
