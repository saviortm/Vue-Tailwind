        ...
        <div class="basis-1/2  max-lg:grid max-lg:justify-items-center max-lg:mx-[50px]">
          <div class="flex flex-col mt-72 max-xl:mt-64 max-lg:mt-0">
            <div class="flex flex-col text-5xl tracking-[-1%] space-y-2 text-[#331B3B] max-xl:text-4xl max-lg:text-3xl max-lg:grid max-lg:justify-items-center">
              ...
              <p class="relative font-light">{{$t('about.second')}} <span class="z-10 line__style__about relative ">{{$t('about.third')}} </span></p>
            </div>
            ...
            <div class="max-lg:grid max-lg:justify-items-center">
              <div class="flex w-52 h-16 bg-[#331B3B] rounded-xl justify-center mt-9 cursor-pointer max-xl:w-48 max-xl:h-14 max-md:w-40 max-md:h-12 max-sm:w-32 max-sm:h-10">
                <p class="flex self-center font-bold text-base text-white max-xl:text-sm max-sm:font-semibold uppercase">{{$t('buttons.explore')}} </p>
              </div>
            </div>
          </div>
        </div>
